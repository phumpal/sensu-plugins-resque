...
require_relative 'lib/sensu-plugins-resque'
...
Gem::Specification.new do |s|
  ...
  s.homepage               = 'https://github.com/sensu-plugins/sensu-plugins-resque'
  s.license                = 'MIT'
  ...
  s.name                   = 'sensu-plugins-resque'
  s.platform               = Gem::Platform::RUBY
  s.post_install_message   = 'You can use the embedded Ruby by setting EMBEDDED_RUBY=true in /etc/default/sensu'
  s.require_paths          = ['lib']
  s.required_ruby_version  = '>= 2.2.2'

  s.summary                = 'Sensu plugins for resque'
